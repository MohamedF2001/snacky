  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: promotionState.isLoading
          ...
          ? Center(child: Text("Erreur A : ${promotionState.error!.toString()}"))
          : GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            onTap: () {
              ...
              context.push('/products/${promotion.id}', extra: promotion.nom);
            },
            ...
            child: Card(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(promotion.dateDebut.toString()),
                  Text(promotion.dateFin.toString()),
                ],
              )
            ),
          );
              ...
              child: Padding(
                ...
                /*Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Expanded(
                      child: _buildProduitsList(promotion),
                    ),
                    const SizedBox(height: 8),
                    // Dates
                    if (promotion.dateDebut != null)
                      Text(
                        "Début : ${_formatDate(promotion.dateDebut!)}",
                        style: const TextStyle(fontSize: 11, color: Colors.grey),
                      ),
                    if (promotion.dateFin != null)
                      Text(
                        "Fin : ${_formatDate(promotion.dateFin!)}",
                        style: const TextStyle(fontSize: 11, color: Colors.grey),
                      ),
                  ],
                ),*/

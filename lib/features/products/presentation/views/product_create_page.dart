...
class _ProductCreatePageState extends ConsumerState<ProductCreatePage> {
  ...
  // Afficher la sélection de catégorie en modal sur mobile
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isDesktop
          ? _buildDesktopLayout(createState, categorieState, filteredCategories)
  ...
  // Layout Desktop (largeur >= 900px)
  Widget _buildDesktopLayout(
      dynamic createState,
      dynamic categorieState,
      List filteredCategories,
      ) {
    return Padding(
      padding: const EdgeInsets.all(24),
      child: Row(
        ...
        children: [
          Expanded(
            flex: 3,
            child: _buildFormCard(createState),
          ),
          const SizedBox(width: 24),
          Expanded(
            flex: 2,
            child: _buildCategoryCard(categorieState, filteredCategories),
          ),
        ],
      ),
    );
  ...
  // Layout Mobile & Tablette (largeur < 900px)
  Widget _buildMobileTabletLayout(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          _buildFormCard(createState),
          const SizedBox(height: 24),
          // Bouton pour ouvrir le modal de sélection de catégorie
          _buildCategorySelectionButton(categorieState, filteredCategories),
        ],
      ),
    );
  }

  Widget _buildFormCard(dynamic createState) {
    final screenWidth = MediaQuery.of(context).size.width;
  ...
  // Card de catégorie pour Desktop
  Widget _buildCategoryCard(dynamic categorieState, List filteredCategories) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
  ...
  // Bouton de sélection de catégorie pour Mobile/Tablette
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        color: _selectedCategorieId != null
                            ? Colors.orange.shade700
                            : Colors.grey.shade600,
                        fontWeight: _selectedCategorieId != null
                            ? FontWeight.w600
                            : FontWeight.normal,
                      ),
                    ),
